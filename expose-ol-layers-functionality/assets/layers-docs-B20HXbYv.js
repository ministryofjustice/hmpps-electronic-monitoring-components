import{u as d,j as e,M as t,T as l,S as c,C as o,a}from"./blocks-WrO7OSnL.js";import{Example as s}from"./layers-example.stories-BQzeZ0aM.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CaN9kTVP.js";import"./setupMapDemo-9xriyf_u.js";function r(i){const n={br:"br",code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Components/Map/Layers/Docs"}),`
...
`,e.jsx(n.h2,{id:"using-native-openlayers-layers",children:"Using native OpenLayers layers"}),`
`,e.jsx(n.p,{children:"In addition to the built-in composable layers, you can use native OpenLayers layers via the NativeLayerWrapper."}),`
`,e.jsx(n.p,{children:"This allows you to:"}),`
`,e.jsx(n.p,{children:`reuse existing OpenLayers code
use advanced OpenLayers features not exposed by composable layers
mix native and composable layers together`}),`
`,e.jsx(n.h3,{id:"basic-usage",children:"Basic usage"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import VectorLayer from 'ol/layer/Vector'
import VectorSource from 'ol/source/Vector'
import { NativeLayerWrapper } from '@ministryofjustice/hmpps-electronic-monitoring-components/map/layers'

const newLayer = new VectorLayer({
  source: new VectorSource(),
})

emMap.addLayer(new NativeLayerWrapper(newLayer))
`})}),`
`,e.jsx(n.h3,{id:"mixing-with-custom-layers",children:"Mixing with custom layers"}),`
`,e.jsx(n.p,{children:"Native layers can be used alongside composable layers:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`emMap.addLayer(new LocationsLayer({ positions }))

emMap.addLayer(
  new NativeLayerWrapper(
    new VectorLayer({ source: new VectorSource() }),
  ),
)
`})}),`
`,e.jsx(n.h3,{id:"interaction",children:"Interaction"}),`
`,e.jsx(n.p,{children:"All wrapped native layers support the same interaction API:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`const layer = new NativeLayerWrapper(new VectorLayer(...))

emMap.addLayer(layer)

layer.getPrimaryLayer().setVisible(false)
layer.getPrimaryLayer().setZIndex(10)
`})}),`
`,e.jsx(n.hr,{}),`
...
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"basic-usage-1",children:"Basic usage"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`emMap.addLayer(new TracksLayer({
  positions,
  visible: true,
