import{u as c,j as e,M as o,T as t,S as l,C as a,a as d}from"./blocks-WrO7OSnL.js";import{Example as r}from"./setup-example.stories-Cfks-TzA.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CaN9kTVP.js";import"./setupMapDemo-9xriyf_u.js";function i(s){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Components/Map/Setup/Docs"}),`
`,e.jsx(t,{children:"Map setup"}),`
`,e.jsx(l,{children:"Interactive map component using OpenLayers or MapLibre"}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"live-example",children:"Live example"}),`
`,e.jsx(a,{of:r,className:"map-docs-canvas"}),`
  ...
  helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: ["'self'", 'data:'],
        connectSrc: ["'self'"],
        workerSrc: ["'self'", "blob:"], // Required for WebGL (OpenLayers workers)
      },
    },
  }),
)
...
`,e.jsx(n.li,{children:`'blob:' in workerSrc required for WebGL rendering
OpenLayers uses Web Workers created from blob: URLs. Without this, maps using WebGL layers will fail to load due to CSP violations.`}),`
...
`]}),`
`]})]})}function u(s={}){const{wrapper:n}={...c(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{u as default};
