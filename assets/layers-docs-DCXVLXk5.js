import{j as e,M as t,T as l,S as c,C as o,a as h}from"./blocks-B1ormq56.js";import{useMDXComponents as d}from"./index-xQHEh3Kx.js";import{Example as i}from"./layers-example.stories-IkLxZrHo.js";import"./iframe-1vGq8O7p.js";import"./setupMapDemo-BomtweBa.js";function r(s){const n={code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Components/Map/Layers/Docs"}),`
...
color?: string;
width?: number;
lineDash?: number[];`]}),"}"]}),e.jsx("code",{children:"}"})]}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Text styling & offset."})]})]})]})]})}function m(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{m as default};
