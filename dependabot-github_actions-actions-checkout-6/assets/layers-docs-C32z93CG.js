import{j as e,M as l,T as t,S as c,C as o,a as h}from"./WithTooltip-SK46ZJ2J-CwBjPHmY.js";import{useMDXComponents as d}from"./index-9abhWB4I.js";import{Example as i}from"./layers-example.stories-CpYONvEj.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-JmIzWqN2.js";import"./setupMapDemo-h06_FbZ0.js";function r(s){const n={code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Components/Map/Layers/Docs"}),`
...
`,e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Option"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Default"}),e.jsx("th",{children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"positions"})}),e.jsx("td",{children:e.jsx("code",{children:"Position[]"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Required line inputs."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"id"})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:e.jsx("code",{children:"tracks"})}),e.jsx("td",{children:"Unique id."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"title"})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Human-readable name."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"visible"})}),e.jsx("td",{children:e.jsx("code",{children:"boolean"})}),e.jsx("td",{children:e.jsx("code",{children:"false"})}),e.jsx("td",{children:"Initial visibility."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"zIndex"})}),e.jsx("td",{children:e.jsx("code",{children:"number"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Draw order."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"style"})}),e.jsxs("td",{children:[e.jsx("code",{children:"{"}),e.jsxs("code",{children:[e.jsxs(n.p,{children:["stroke: ","{",`
...
color?: string;
width?: number;
lineDash?: number[];`]}),"}"]}),e.jsx("code",{children:"}"})]}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Text styling & offset."})]})]})]})]})}function u(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{u as default};
