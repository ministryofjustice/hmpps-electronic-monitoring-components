...
${er}
`,V=Kn();class ir{constructor(){this.uniforms_=[],this.attributes_=[],this.hasSymbol_=!1,this.symbolSizeExpression_=`vec2(${$(V["circle-radius"])} + ${$(V["circle-stroke-width"]*.5)})`,this.symbolRotationExpression_="0.0",this.symbolOffsetExpression_="vec2(0.0)",this.symbolColorExpression_=ie(V["circle-fill-color"]),this.texCoordExpression_="vec4(0.0, 0.0, 1.0, 1.0)",this.discardExpression_="false",this.symbolRotateWithView_=!1,this.hasStroke_=!1,this.strokeWidthExpression_=$(V["stroke-width"]),this.strokeColorExpression_=ie(V["stroke-color"]),this.strokeOffsetExpression_="0.",this.strokeCapExpression_=A("round"),this.strokeJoinExpression_=A("round"),this.strokeMiterLimitExpression_="10.",this.strokeDistanceFieldExpression_="-1000.",this.strokePatternLengthExpression_=null,this.hasFill_=!1,this.fillColorExpression_=ie(V["fill-color"]),this.vertexShaderFunctions_=[],this.fragmentShaderFunctions_=[]}addUniform(e,t){return this.uniforms_.push({name:e,type:t}),this}addAttribute(e,t,n,s){return this.attributes_.push({name:e,type:t,varyingName:e.replace(/^a_/,"v_"),varyingType:s??t,varyingExpression:n??e}),this}setSymbolSizeExpression(e){return this.hasSymbol_=!0,this.symbolSizeExpression_=e,this}getSymbolSizeExpression(){return this.symbolSizeExpression_}setSymbolRotationExpression(e){return this.symbolRotationExpression_=e,this}setSymbolOffsetExpression(e){return this.symbolOffsetExpression_=e,this}getSymbolOffsetExpression(){return this.symbolOffsetExpression_}setSymbolColorExpression(e){return this.hasSymbol_=!0,this.symbolColorExpression_=e,this}getSymbolColorExpression(){return this.symbolColorExpression_}setTextureCoordinateExpression(e){return this.texCoordExpression_=e,this}setFragmentDiscardExpression(e){return this.discardExpression_=e,this}getFragmentDiscardExpression(){return this.discardExpression_}setSymbolRotateWithView(e){return this.symbolRotateWithView_=e,this}setStrokeWidthExpression(e){return this.hasStroke_=!0,this.strokeWidthExpression_=e,this}setStrokeColorExpression(e){return this.hasStroke_=!0,this.strokeColorExpression_=e,this}getStrokeColorExpression(){return this.strokeColorExpression_}setStrokeOffsetExpression(e){return this.strokeOffsetExpression_=e,this}setStrokeCapExpression(e){return this.strokeCapExpression_=e,this}setStrokeJoinExpression(e){return this.strokeJoinExpression_=e,this}setStrokeMiterLimitExpression(e){return this.strokeMiterLimitExpression_=e,this}setStrokeDistanceFieldExpression(e){return this.strokeDistanceFieldExpression_=e,this}setStrokePatternLengthExpression(e){return this.strokePatternLengthExpression_=e,this}getStrokePatternLengthExpression(){return this.strokePatternLengthExpression_}setFillColorExpression(e){return this.hasFill_=!0,this.fillColorExpression_=e,this}getFillColorExpression(){return this.fillColorExpression_}addVertexShaderFunction(e){return this.vertexShaderFunctions_.includes(e)?this:(this.vertexShaderFunctions_.push(e),this)}addFragmentShaderFunction(e){return this.fragmentShaderFunctions_.includes(e)?this:(this.fragmentShaderFunctions_.push(e),this)}getSymbolVertexShader(){return this.hasSymbol_?`${j}
...
`)}
}`:null}getSymbolFragmentShader(){return this.hasSymbol_?`${j}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec2 v_texCoord;
varying vec4 v_hitColor;
...
}`:null}getStrokeVertexShader(){return this.hasStroke_?`${j}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
...
${this.attributes_.map(e=>`  ${e.varyingName} = ${e.varyingExpression};`).join(`
`)}
}`:null}getStrokeFragmentShader(){return this.hasStroke_?`${j}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec2 v_segmentStartPx;
varying vec2 v_segmentEndPx;
...
}`:null}getFillVertexShader(){return this.hasFill_?`${j}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
attribute vec2 a_position;
attribute vec2 a_hitColor;
...
${this.attributes_.map(e=>`  ${e.varyingName} = ${e.varyingExpression};`).join(`
`)}
}`:null}getFillFragmentShader(){return this.hasFill_?`${j}
${this.uniforms_.map(e=>`uniform ${e.type} ${e.name};`).join(`
`)}
varying vec4 v_hitColor;
${this.attributes_.map(e=>`varying ${e.varyingType} ${e.varyingName};`).join(`
...
}`:null}}function ue(r){return(JSON.stringify(r).split("").reduce((t,n)=>(t<<5)-t+n.charCodeAt(0),0)>>>0).toString()}function Ve(r,e,t,n){if(`${n}radius`in r&&n!=="icon-"){let s=g(t,r[`${n}radius`],x);if(`${n}radius2`in r){const i=g(t,r[`${n}radius2`],x);s=`max(${s}, ${i})`}`${n}stroke-width`in r&&(s=`(${s} + ${g(t,r[`${n}stroke-width`],x)} * 0.5)`),e.setSymbolSizeExpression(`vec2(${s} * 2. + 0.5)`)}if(`${n}scale`in r){const s=g(t,r[`${n}scale`],k);e.setSymbolSizeExpression(`${e.getSymbolSizeExpression()} * ${s}`)}`${n}displacement`in r&&e.setSymbolOffsetExpression(g(t,r[`${n}displacement`],O)),`${n}rotation`in r&&e.setSymbolRotationExpression(g(t,r[`${n}rotation`],x)),`${n}rotate-with-view`in r&&e.setSymbolRotateWithView(!!r[`${n}rotate-with-view`])}function St(r,e,t,n,s){let i="vec4(0.)";if(e!==null&&(i=e),t!==null&&n!==null){const l=`smoothstep(-${n} + 0.63, -${n} - 0.58, ${r})`;i=`mix(${t}, ${i}, ${l})`}const o=`(1.0 - smoothstep(-0.63, 0.58, ${r}))`;let a=`${i} * vec4(1.0, 1.0, 1.0, ${o})`;return s!==null&&(a=`${a} * vec4(1.0, 1.0, 1.0, ${s})`),a}function Xe(r,e,t,n,s){const i=new Image;i.crossOrigin=r[`${n}cross-origin`]===void 0?"anonymous":r[`${n}cross-origin`],pe(typeof r[`${n}src`]=="string",`WebGL layers do not support expressions for the ${n}src style property`),i.src=r[`${n}src`],t[`u_texture${s}_size`]=()=>i.complete?[i.width,i.height]:[0,0],e.addUniform(`u_texture${s}_size`,"vec2");const o=`u_texture${s}_size`;return t[`u_texture${s}`]=i,e.addUniform(`u_texture${s}`,"sampler2D"),o}function He(r,e,t,n,s){let i=g(t,r[`${e}offset`],k);if(`${e}offset-origin`in r)switch(r[`${e}offset-origin`]){case"top-right":i=`vec2(${n}.x, 0.) + ${s} * vec2(-1., 0.) + ${i} * vec2(-1., 1.)`;break;case"bottom-left":i=`vec2(0., ${n}.y) + ${s} * vec2(0., -1.) + ${i} * vec2(1., -1.)`;break;case"bottom-right":i=`${n} - ${s} - ${i}`;break}return i}function sr(r,e,t,n){n.functions.circleDistanceField=`float circleDistanceField(vec2 point, float radius) {
  return length(point) - radius;
}`,Ve(r,e,n,"circle-");let s=null;"circle-opacity"in r&&(s=g(n,r["circle-opacity"],x));let i="coordsPx";"circle-scale"in r&&(i=`coordsPx / ${g(n,r["circle-scale"],k)}`);let o=null;"circle-fill-color"in r&&(o=g(n,r["circle-fill-color"],P));let a=null;"circle-stroke-color"in r&&(a=g(n,r["circle-stroke-color"],P));let l=g(n,r["circle-radius"],x),c=null;"circle-stroke-width"in r&&(c=g(n,r["circle-stroke-width"],x),l=`(${l} + ${c} * 0.5)`);const u=`circleDistanceField(${i}, ${l})`,d=St(u,o,a,c,s);e.setSymbolColorExpression(d)}function or(r,e,t,n){n.functions.round=`float round(float v) {
...
}`,Ve(r,e,n,"shape-");let s=null;"shape-opacity"in r&&(s=g(n,r["shape-opacity"],x));let i="coordsPx";"shape-scale"in r&&(i=`coordsPx / ${g(n,r["shape-scale"],k)}`);let o=null;"shape-fill-color"in r&&(o=g(n,r["shape-fill-color"],P));let a=null;"shape-stroke-color"in r&&(a=g(n,r["shape-stroke-color"],P));let l=null;"shape-stroke-width"in r&&(l=g(n,r["shape-stroke-width"],x));const c=g(n,r["shape-points"],x);let u="0.";"shape-angle"in r&&(u=g(n,r["shape-angle"],x));let d,h=g(n,r["shape-radius"],x);if(l!==null&&(h=`${h} + ${l} * 0.5`),"shape-radius2"in r){let p=g(n,r["shape-radius2"],x);l!==null&&(p=`${p} + ${l} * 0.5`),d=`starDistanceField(${i}, ${c}, ${h}, ${p}, ${u})`}else d=`regularDistanceField(${i}, ${c}, ${h}, ${u})`;const f=St(d,o,a,l,s);e.setSymbolColorExpression(f)}function ar(r,e,t,n){let s="vec4(1.0)";"icon-color"in r&&(s=g(n,r["icon-color"],P)),"icon-opacity"in r&&(s=`${s} * vec4(1.0, 1.0, 1.0, ${g(n,r["icon-opacity"],x)})`);const i=ue(r["icon-src"]),o=Xe(r,e,t,"icon-",i);if(e.setSymbolColorExpression(`${s} * texture2D(u_texture${i}, v_texCoord)`).setSymbolSizeExpression(o),"icon-width"in r&&"icon-height"in r&&e.setSymbolSizeExpression(`vec2(${g(n,r["icon-width"],x)}, ${g(n,r["icon-height"],x)})`),"icon-offset"in r&&"icon-size"in r){const a=g(n,r["icon-size"],O),l=e.getSymbolSizeExpression();e.setSymbolSizeExpression(a);const c=He(r,"icon-",n,"v_quadSizePx",a);e.setTextureCoordinateExpression(`(vec4((${c}).xyxy) + vec4(0., 0., ${a})) / (${l}).xyxy`)}if(Ve(r,e,n,"icon-"),"icon-anchor"in r){const a=g(n,r["icon-anchor"],O);let l="1.0";"icon-scale"in r&&(l=g(n,r["icon-scale"],k));let c;r["icon-anchor-x-units"]==="pixels"&&r["icon-anchor-y-units"]==="pixels"?c=`${a} * ${l}`:r["icon-anchor-x-units"]==="pixels"?c=`${a} * vec2(vec2(${l}).x, v_quadSizePx.y)`:r["icon-anchor-y-units"]==="pixels"?c=`${a} * vec2(v_quadSizePx.x, vec2(${l}).x)`:c=`${a} * v_quadSizePx`;let u=`v_quadSizePx * vec2(0.5, -0.5) + ${c} * vec2(-1., 1.)`;if("icon-anchor-origin"in r)switch(r["icon-anchor-origin"]){case"top-right":u=`v_quadSizePx * -0.5 + ${c}`;break;case"bottom-left":u=`v_quadSizePx * 0.5 - ${c}`;break;case"bottom-right":u=`v_quadSizePx * vec2(-0.5, 0.5) + ${c} * vec2(1., -1.)`;break}e.setSymbolOffsetExpression(`${e.getSymbolOffsetExpression()} + ${u}`)}}function lr(r,e,t,n){if("stroke-color"in r&&e.setStrokeColorExpression(g(n,r["stroke-color"],P)),"stroke-pattern-src"in r){const s=ue(r["stroke-pattern-src"]),i=Xe(r,e,t,"stroke-pattern-",s);let o=i,a="vec2(0.)";"stroke-pattern-offset"in r&&"stroke-pattern-size"in r&&(o=g(n,r["stroke-pattern-size"],O),a=He(r,"stroke-pattern-",n,i,o));let l="0.";"stroke-pattern-spacing"in r&&(l=g(n,r["stroke-pattern-spacing"],x));let c="0.";"stroke-pattern-start-offset"in r&&(c=g(n,r["stroke-pattern-start-offset"],x)),n.functions.sampleStrokePattern=`vec4 sampleStrokePattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, float spacingPx, float startOffsetPx, float currentLengthPx, float currentRadiusRatio, float lineWidth) {
