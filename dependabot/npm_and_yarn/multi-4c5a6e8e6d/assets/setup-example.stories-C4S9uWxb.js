import{p as r,s as p}from"./setupMapDemo-D-mSOQ-N.js";import"./iframe-BqPRJFa1.js";import"./preload-helper-PPVm8Dsz.js";const c={title:"Components/Map/Setup",parameters:{layout:"fullscreen"},argTypes:{renderer:{control:"select",options:["openlayers","maplibre"]},enable3D:{control:"boolean",if:{arg:"renderer",eq:"maplibre"},description:"Only available for MapLibre renderer"},positions:{control:"object",description:"Array of positions (empty array simulates no data)"},usesInternalOverlays:{control:"boolean",description:"Enable click-to-open overlays (injects demo templates automatically)"},"controls.zoomSlider":{control:"boolean"},"controls.rotate":{control:"select",options:["true","auto-hide","false"]},"controls.scale":{control:"select",options:["bar","line","false"]},"controls.locationDisplay":{control:"select",options:["dms","latlon","false"]},"controls.grabCursor":{control:"boolean"}},render:a=>{const s=document.createElement("div");return s.classList.add("map-container"),p({container:s,positions:a.positions,renderer:a.renderer,enable3D:a.enable3D,usesInternalOverlays:a.usesInternalOverlays,controls:{zoomSlider:a["controls.zoomSlider"],rotate:a["controls.rotate"],scale:a["controls.scale"],locationDisplay:a["controls.locationDisplay"],grabCursor:a["controls.grabCursor"]},showPositions:!0,showTracks:!1,showText:!1,showCircles:!1}),s}},o={args:{renderer:"openlayers",enable3D:!0,positions:r,usesInternalOverlays:!0,"controls.zoomSlider":!1,"controls.rotate":"false","controls.scale":"false","controls.locationDisplay":"false","controls.grabCursor":!0},parameters:{docs:{source:{language:"njk",transform:(a,s)=>{const e=s.args,l=e.renderer==="maplibre"?`
