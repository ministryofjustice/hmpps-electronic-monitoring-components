import{j as e,M as l,T as c,S as t,C as o,a as h}from"./WithTooltip-SK46ZJ2J-qZjqK6rA.js";import{useMDXComponents as d}from"./index-CUJ9n-rf.js";import{Example as i}from"./layers-example.stories-X_eBoCnh.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-Cl2cNNgQ.js";import"./setupMapDemo-BZGk4Rfr.js";function r(s){const n={code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Components/Map/Layers/Docs"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx("code",{children:"id?: string"})," — unique id (defaults to layer type: ",e.jsx("code",{children:"locations"})," / ",e.jsx("code",{children:"tracks"})," / ",e.jsx("code",{children:"circles"})," / ",e.jsx("code",{children:"numbering"}),")"]}),`
...
`,e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Option"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Default"}),e.jsx("th",{children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"positions"})}),e.jsx("td",{children:e.jsx("code",{children:"Position[]"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Required point inputs."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"id"})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:e.jsx("code",{children:"numbering"})}),e.jsx("td",{children:"Unique id."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"title"})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Human-readable name."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"visible"})}),e.jsx("td",{children:e.jsx("code",{children:"boolean"})}),e.jsx("td",{children:e.jsx("code",{children:"false"})}),e.jsx("td",{children:"Initial visibility."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"zIndex"})}),e.jsx("td",{children:e.jsx("code",{children:"number"})}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Draw order."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"numberProperty"})}),e.jsx("td",{children:e.jsx("code",{children:"string"})}),e.jsx("td",{children:e.jsx("code",{children:"label"})}),e.jsx("td",{children:"Feature property to display."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"style"})}),e.jsxs("td",{children:[e.jsx("code",{children:"{"})," ",e.jsxs("code",{children:["font: string; fill: string; stroke: ","{"," color: string; width: number ","}","; offset: ","{"," x: number; y: number ","}"," ","}"]})]}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Text styling & offset."})]})]})]})]})}function u(s={}){const{wrapper:n}={...d(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{u as default};
