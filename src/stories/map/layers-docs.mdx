...
<Subtitle>Visualising positions, tracks, circles, and numbering</Subtitle>
...
```ts
// Create a layer (any of LocationsLayer, TracksLayer, CirclesLayer, NumberingLayer)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>NumberingLayer</code></td>
      <td>Paints numeric labels (e.g. <code>sequenceNumber</code>) next to points.</td>
      <td>Point</td>
      <td><code>numbering</code></td>
    </tr>
  </tbody>
</table>
...
- <code>id?: string</code> — unique id (defaults to layer type: <code>locations</code> / <code>tracks</code> / <code>circles</code> / <code>numbering</code>)  
...
```ts
emMap.addLayer(new NumberingLayer({
  positions,
...
### <code>NumberingLayer(options)</code>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>visible</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Initial visibility.</td></tr>
    <tr><td><code>zIndex</code></td><td><code>number</code></td><td>—</td><td>Draw order.</td></tr>
    <tr><td><code>numberProperty</code></td><td><code>string</code></td><td><code>sequenceNumber</code></td><td>Feature property to display.</td></tr>
    <tr>
      <td><code>style</code></td>
